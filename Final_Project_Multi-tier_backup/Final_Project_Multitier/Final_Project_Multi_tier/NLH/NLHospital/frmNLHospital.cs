...
namespace NLHospital
{
	...
	public class frmNLHospital : NLHBase
	{
		...
		public string getPosition(string username) 
		{
			...
			{
				con.Open();
				SqlCommand cmd = new SqlCommand("SELECT Position FROM login WHERE UserName='" + username + "'", con);
			...
			try
			{
				...
				switch (position)
				{
					...
					case "Admin":
						...
						menuFrm.oCurrent.UserName = position;
						menuFrm.Visible = true;
						menuFrm.Activate();
						menuFrm.SelectUser();
						break;
					case "Nurse":
						frmMenu menuFm = new frmMenu();
						menuFm.oCurrent.UserName = position;
						menuFm.Visible = true;
						menuFm.Activate();
						menuFm.SelectUser();
						break;
					case "Doctor":
						...
						menuForm.oCurrent.UserName = position;
